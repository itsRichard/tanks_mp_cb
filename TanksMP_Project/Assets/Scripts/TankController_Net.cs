...
public class TankController_Net :  NetworkBehaviour
{
	...
	void Start()
	{
		...
		if (!isLocalPlayer) 
		{
			//...then remove this script. This is important because this tank (not the local player) 
			//won't need to control the camera, move on its own, or really do anything interactive. 
